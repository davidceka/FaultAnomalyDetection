...
filename = '/Users/davidceka/Documents/uni/manutenzione/FaultAnomalyDetection/mat_files/carbonZ_2018-07-18-15-53-31_1_engine_failure.mat';
...
roll_topic = Sequence.GetTopicByName('mavros_nav_info_velocity');
...
% Plot the data
figure;
plot(times, roll_topic.Data.meas_x);
hold on; grid on;
plot(times, roll_topic.Data.meas_y);
hold off
